...
\begin{table}[H]
\caption{\textbf{Tabla 13.} \textit{Evaluación frente a los criterios de éxito predefinidos en la Tabla~\ref{tab:criterios}. Referencia sMAPE Seasonal Naïve: 14.45\%.}}
